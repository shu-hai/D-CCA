...
#Use user-specified r_1 and r_2 (e.g., from the scree plot), and estimate r_12 by 'MDL-IC'
X_1_hat, X_2_hat, C_1_hat, C_2_hat, D_1_hat, D_2_hat, r_1_hat, r_2_hat, r_12_hat, ccor_hat, theta_hat = dcca.dCCA(Y_1, Y_2, r_1=r_1, r_2=r_2)
